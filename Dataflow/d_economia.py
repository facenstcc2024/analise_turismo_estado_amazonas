...
pipeline_options_dict = {
    ...
    'template_location': 'gs://dados_tcc_facens_sp/template/tab_d_economia_lucas' }
...
with beam.Pipeline(options=pipeline_options) as p1:
    products_1 = (
        ...
        | 'Importando os Dados Tabela 1' >> beam.io.ReadFromText(
            r'gs://dados_tcc_facens_sp/inputs/d_economia.csv', 
            skip_header_lines=1)
        ...
        | 'Salvando no Bucket Tabela 1' >> beam.io.WriteToText(
            r'gs://dados_tcc_facens_sp/output/tabela_d_economia_turistica.csv')
    )